...
import vertx.core.AsyncResult;
import vertx.core.Future;
import vertx.core.Handler;
import vertx.json.JsonObject;
...
public interface Context {
  ...
  static boolean isOnWorkerThread() {
    return false;//ContextImpl.isOnWorkerThread();
  }
  ...
  static boolean isOnEventLoopThread() {
    return false;//ContextImpl.isOnEventLoopThread();
  }
  ...
  static boolean isOnVertxThread() {
    return false;//ContextImpl.isOnVertxThread();
  }
