...
public class Test {
  ...
  public void foo(final Object[] array, Test other) {
  ...
  @Unique("this")
  public void bad1(final Object[] array, @Unique Test other1, @Unique Test other2) {
  	array[0] = other1.u;
    readsInstance(other1); // trigger error in opLoadReachable() via considerEffects()
  }
  
  @Unique("this")
  public void bad2(final Object[] array, @Unique Test other1, @Unique Test other2) {
  ...
  @Unique("this")
  public void bad3(final Object[] array, @Unique Test other1, @Unique Test other2) {
    // Test that different parameters are distinguished by the error
  	array[0] = other2.u;
    readsInstance(this); // okay
  ...
  @Unique("this")
  public void bad4(final Object[] array, @Unique Test other1, @Unique Test other2) {
  ...
  @Unique("this")
  public void bad5(final Object[] array, @Unique Test other1, @Unique Test other2) {
  ...
  @Unique("this")
  public void bad6(final Object[] array, @Unique Test other1, @Unique Test other2) {
  ...
  @Unique("this")
  public void bad7(final Object[] array, @Unique Test other1, @Unique Test other2) {
    // Test that receiver is properly handled as the formal parameter and that other variables can be used as the actual 
  	array[0] = other2.u;
    this.readsInstance(); // good
  ...
  @Unique("this")
  public void bad8(final Object[] array, @Unique Test other1, @Unique Test other2) {
    // Test that receiver is properly handled as the formal parameter AND as actual
  	array[0] = this.u;
    other1.readsInstance(); // good
    other2.readsInstance(); // good
