package opCheckMutable.viaConsiderDeclaredEffects.transferCall.formal.instanceTarget.write;
...
public class WriteTest {
  ...
  public void fieldRef_readOnly() {
    C.sharedC.doStuff(this.readOnlyField); // BAD
  }

  public void fieldRef_immutable() {
    C.sharedC.doStuff(this.immutableField); // BAD
  }
