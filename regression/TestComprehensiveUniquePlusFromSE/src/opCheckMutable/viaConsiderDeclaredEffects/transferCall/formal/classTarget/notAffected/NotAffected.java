package opCheckMutable.viaConsiderDeclaredEffects.transferCall.formal.classTarget.notAffected;
...
class C extends A {
  ...
  @RegionEffects("writes opCheckMutable.viaConsiderDeclaredEffects.transferCall.formal.classTarget.notAffected.Other:Region")
  @Borrowed("this")
