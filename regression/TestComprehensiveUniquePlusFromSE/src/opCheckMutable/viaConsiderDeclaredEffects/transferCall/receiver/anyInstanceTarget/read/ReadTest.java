package opCheckMutable.viaConsiderDeclaredEffects.transferCall.receiver.anyInstanceTarget.read;
 ...
 * 
 * Here we test the case where the called method READS an any instance target
...
@Region("public State")
class C extends A {
  @RegionEffects("reads any(C):State")
  @Borrowed("this")
  public void doStuff() {
    // stuff
  }
