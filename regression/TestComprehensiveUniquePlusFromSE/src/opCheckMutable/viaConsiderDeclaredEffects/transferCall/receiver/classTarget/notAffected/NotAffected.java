package opCheckMutable.viaConsiderDeclaredEffects.transferCall.receiver.classTarget.notAffected;
 ...
 * 
 * Here we test the case where the called method affects a class target
...
class C extends A {
  @RegionEffects("writes opCheckMutable.viaConsiderDeclaredEffects.transferCall.receiver.classTarget.notAffected.Other:Region")
  @Borrowed("this")
  public void doStuff() {
    // stuff
  }
