package opCheckMutable.viaConsiderDeclaredEffects.transferCall.formal.anyInstanceTarget.write;
 ...
 * 
 * Here we test the case where the called method WRITES an any instance target
...
public class WriteTest {
  ...
  public void fieldRef_readOnly() {
    (new C()).doStuff(this.readOnlyField); // BAD
  }

  public void fieldRef_immutable() {
    (new C()).doStuff(this.immutableField); // BAD
  }
...
class C extends A {
  ...
  @RegionEffects("writes any(C):State")
  @Borrowed("this")
