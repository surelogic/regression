package opCheckMutable.viaConsiderDeclaredEffects.transferCall.receiver.classTarget.write;
 ...
 * 
 * Here we test the case where the called method WRITES a class target
