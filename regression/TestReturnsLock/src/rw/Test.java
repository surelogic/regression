...
public class Test {
	...
	private final ReadWriteLock other = new ReentrantReadWriteLock();
	
	private final static ReadWriteLock s2 = new ReentrantReadWriteLock();
	private final static ReadWriteLock s3 = new ReentrantReadWriteLock();
