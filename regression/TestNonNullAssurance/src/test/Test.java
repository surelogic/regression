...
public class Test {
  ...
  public void testFieldRef(final boolean f, final @Nullable Other o1,
      final @NonNull Other o2, @Raw Other o3, @Raw(upTo="Parent") Other o4) {
    int l1 = o1.f; // bad
    int l2 = o1.s; // good
    int l3 = Other.s; // good
    int l4 = o2.f; // good
  ...
  public void testCrement(
      ...
      @NonNull Integer i2, @Raw Integer i3, @Raw(upTo="java.lang.Object") Integer o4,
      @Nullable int[] a1, @NonNull int[] a2, @Nullable final Other o1,
      final @NonNull Other o2, @Raw Other o3) {
    i1++; // bad
    i2--; // good
  ...
  public void testCompoundAssignmentErrorFromUnbox(
      ...
      @NonNull Integer o2, @Raw Integer o3, @Raw(upTo="java.lang.Object") Integer o4) {
    o1 += 0; // bad
    @Raw
    Integer x = o2 += 0; // good
    o3 += 0; // good
